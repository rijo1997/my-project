        ...
        function validatp(){
            ...
            if (a!=b) {
               ...
               return false;
						...
						<p align=left style="color:#1accfd;">Enter Current Password: <input type="password" required="" value="current Password"  name="password" id="pas" > </p> -->
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle nav-stylehead" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Select Regions
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle nav-stylehead" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Recipe
										<span class="caret"></span>
									</a>
			...
			<div class="agileinfo-ads-display col-md-13">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Newly  arrival Halwa's</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Apple Halwa in East India</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs150 for 500gm</span>
										<del>Rs.180</del>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Pinapple halwa in South India</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs.140 for 500gm</span>
										<del>Rs.180</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">carrot halwa in West india</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs.120 for 700gm</span>
										<del>Rs.140</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Ghee Halwa in South India</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs.160 for 500gm </span>
										<del>Rs.190</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Kesar marshmellow  Halwa in North India </a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs.160 for 500gm</span>
										<del>Rs180.00</del>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Badam Halwa in South India</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">Rs.270</span>
										<del>Rs.300</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
