...
$sql="SELECT * FROM tbl_product WHERE Status='1' AND category_id='$id' ORDER BY p_id DESC";
...
<?php
						...
						$sql="SELECT * FROM signup WHERE email='$id1'";
						$result=mysqli_query($con,$sql);
			...
			<!-- product right -->
				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle"><?php echo $n;   ?> Halwa's</h3>
